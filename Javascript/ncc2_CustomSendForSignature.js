...
function triggerFlow_CreateAdobeDocument(email) {
    ...
    url = "https://prod-10.westus.logic.azure.com:443/workflows/5b62965140b94e9cb1c52cad21ce429c/triggers/manual/paths/invoke?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=Qj8BmnsKgEOPerYUt1LEvlfCIjdRA8CgIsVcP7Mi5kc";
    ...
    if (request.readyState == 4 && request.status == 200) {
        ...
        try {
            ...
            if (LOG) console.log('path:', 'https://uscotton.sharepoint.com/sites/AdobeSignTempReportStorage'+path);
...
function triggerFlow_CreateAdobeAgreement() {
    ...
    url = "https://prod-100.westus.logic.azure.com:443/workflows/ea5e5b8c88564757a83ea3759450b9b8/triggers/manual/paths/invoke?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=vB0cW6X2IzjsiK1slvKqQSPj5lMvBiTqBuMtgrGgeHs";
    var request = new XMLHttpRequest();
    request.open('POST', url, false);
    request.setRequestHeader("Content-Type", "application/json");  
